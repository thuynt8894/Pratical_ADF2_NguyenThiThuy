...
public class PriorityQueue {
    ArrayList<InfoCustomer> array = new ArrayList<>();
    public void Add(ArrayList array){
        ...
        InfoCustomer khachhang = new InfoCustomer(id,name,address,phone,ngaydi,ngayTrove);
        array.add(khachhang);
    }

    public PriorityQueue(ArrayList<InfoCustomer> array) {
        this.array = array;
    }
